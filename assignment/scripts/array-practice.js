...
let foodArray = ['apple', 'pomegranate', 'lime', 'cherry'];
...
console.log('Added an animal to the end', foodArray);
...
console.log('I went vegan and no longer eat', removedFood);
//^like I said, I have the sense of humor of a 50-year-old man
...
console.log(`Added food to the beginnning: ${foodArray}`);
